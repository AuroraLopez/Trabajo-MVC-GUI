...
public class ParticipaPrestamo {
    ...
    // public ParticipaPrestamo(Libros libro, Usuarios usuario, String
    // fecha_prestamo, String fecha_devolucion) {
    // this.libro = libro;
    ...
    // @Override
    // public String toString() {
    // return "ParticipaPrestamo [libro=" + libro + ", usuario=" + usuario + ",
